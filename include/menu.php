...
<nav class="blue darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36"></i>SURAMADU</a>
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
								...
								<li><a href="?page=sett&sub=ret">Retensi</a></li>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">mail</i>SURAMADU</a></li>
            <li><div class="grs"></></li>
