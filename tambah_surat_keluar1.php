...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if (
            ...
            //$no_agendak = $_REQUEST['no_agendak'];
            $nkode = $_REQUEST['kode'];
            ...
            $id_next = mysqli_query($config, "SELECT max(id_surat) as id_next FROM tbl_surat_keluar where tgl_surat='$tglx' "); //1616 //menentukan max id_surat dari tgl srt
            $data_id = mysqli_fetch_array($id_next); //1616
            $idn = $data_id['id_next'];
            ...
            <div class="col s12">
                <nav class="secondary-nav">
                    <div class="nav-wrapper blue-grey darken-1">
                        <ul class="left">
                            <li class="waves-effect waves-light"><a href="?page=tsk&act=add" class="judul"><i class="material-icons">drafts</i> Tambah Data Surat Keluar </a>(File Surat Wajib Diupload!!)</li>
                        </ul>
                    </div>
                </nav>
            </div>
        ...
        <div class="row jarak-form">
            ...
            <form class="col s12" method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s6">
                        <i class="material-icons prefix md-prefix">low_priority</i><label>Pilih Bidang</label><br />
                        <div class="input-field col s11 right">
                            <select name="bidang" class="browser-grey validate" id="bidang" required>
                                <option value="104.1">Sekretariat</option>
                                <option value="104.2">PSDA</option>
                                <option value="104.3">SWP</option>
                                <option value="104.4">Irigasi</option>
                                <option value="104.5">Binfat</option>
                                <option value="104.6.02">UPT Kediri</option>
                                <option value="104.6.02">Korwil Malang</option>
                                <option value="104.6.02">Korwil Surabaya</option>
                                <option value="104.6.05">UPT Bojonegoro</option>
                                <option value="104.6.05">Korwil Madiun</option>
                                <option value="104.6.06">UPT Bondowoso</option>
                                <option value="104.6.07">UPT Lumajang</option>
                                <option value="104.6.08">UPT Pasuruan</option>
                                <option value="104.6.09">UPT Madura</option>
                            </select>
                        </div>
                        <?php
