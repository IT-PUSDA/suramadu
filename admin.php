        ...
        if(isset($_REQUEST['page'])){
            ...
            switch ($page) {
                ...
                case 'ctk':
                    ...
                    break;
				case 'ctk_ter':
                    include "cetak_terusan.php";
                    break;
                case 'tsk':
                    include "transaksi_surat_keluar.php";
                    break;
				case 'not':
                    include "transaksi_nota_dinas.php";
                    break;
                case 'asm':
                ...
                case 'ask':
                    ...
                    break;
				case 'tdl':
                    include "transaksi_tindak_lanjut.php";
                    break;	
                case 'ref':
            ...
            <div class="col s12 m4">
                <div class="card lime darken-1">
                    <div class="card-content">
                        ...
                        <a href="?page=tsk"><?php echo '<h5 class="white-text link">'.$count2.' Surat Keluar</h5>'; ?></a>
                    </div>
                </div>
            </div>
			<!--
			<div class="col s12 m4">
                <div class="card yellow darken-1">
                    <div class="card-content">
                        ...
                        <a href="?page=not"><?php echo '<h5 class="white-text link">'.$count6.' Nota Dinas</h5>'; ?></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col s12 m4">
                <div class="card deep-orange">
                    <div class="card-content">
                        ...
                        <a href="?page=ref"><?php echo '<h5 class="white-text link">'.$count4.' Klasifikasi Surat</h5>'; ?></a>
                    </div>
                </div>
            </div>
			-->
