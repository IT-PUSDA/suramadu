                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                if(empty($row['file'])){
                                    ...
                                    if(in_array($eks, $ekstensi) == true){
                                        echo '
                                            <div class="col m3">
                                                <img class="file" data-caption="'.date('d M Y', strtotime($row['tgl_diterima'])).'" src="./upload/surat_masuk/'.$row['file'].'"/>
                                        ...
                                        if(in_array($eks, $ekstensi2) == true){
                                            echo '
                                                <div class="col m3">
                                                    <img class="file" data-caption="'.date('d M Y', strtotime($row['tgl_diterima'])).'" src="./asset/img/word.png"/>
                                                    <a class="btn light-green darken-1" href="?page=gsm&act=fsm&id_surat='.$row['id_surat'].'">Lihat Detail File</a>
                                                </div>';
                                        } else {
                                            echo '
                                                <div class="col m3">
                                                    <img class="file" data-caption="'.date('d M Y', strtotime($row['tgl_diterima'])).'" src="./asset/img/pdf.png"/>
                                                    <a class="btn light-green darken-1" href="?page=gsm&act=fsm&id_surat='.$row['id_surat'].'">Lihat Detail File</a>
                                                </div>';
                                        }
                                    }
