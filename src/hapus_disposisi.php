            ...
            while($row = mysqli_fetch_array($query)){
    		  ...
    		  echo '<!-- Row form Start -->
            				        ...
            				        <table>
            				            ...
            				            <tbody>
            				                <tr>
            				                    ...
            				                    <td width="1%">:</td>
            				                    <td width="86%">'.$row['tujuan_disposisi'].'</td>
            				                </tr>
            				                <tr>
            				                ...
            				                <tr>
            				                    ...
            				                    <td width="1%">:</td>
            				                    <td width="86%">'.date('d M Y', strtotime($row['tgl_disposisi'])).'</td>
            				                </tr>
                                            <tr>
                	...
                	if(isset($_REQUEST['submit'])){
						...
						$query1 = mysqli_query($config, "DELETE FROM tbl_tindak_lanjut WHERE id_disposisi='$id_disposisi'");
