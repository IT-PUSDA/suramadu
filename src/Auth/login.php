...
<body class="blue-grey lighten-3 bg">
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    if (isset($_REQUEST['submit'])) {
                        ...
                        if ($_REQUEST['username'] == "" || $_REQUEST['password'] == "") {
                            echo '<div class="upss red-text"><i class="material-icons">error_outline</i> <strong>ERROR!</strong> Username dan Password wajib diisi.
                                <a class="btn-large waves-effect waves-light blue-grey col s11" href="index.php" style="margin: 20px 0 0 5px;"><i class="material-icons md-24">arrow_back</i> Kembali ke login form</a></div>';
                        } else {
                            ...
                            $query = mysqli_query($config, "SELECT id_user, username, nama, nip, admin, kode_bidang FROM tbl_user WHERE username=BINARY'$username' AND password=MD5('$password')");
                     

                            if (mysqli_num_rows($query) > 0) {
                                list($id_user, $username, $nama, $nip, $admin, $kode_bidang) = mysqli_fetch_array($query);
                                //buat session
                                ...
                                $_SESSION['kode_bidang'] = $kode_bidang;
                    ...
                    ?>
                        ...
                        <form class="col s12 m12 offset-4 offset-4" method="POST" action="">
                            ...
                            <div class="input-field col s12">
                                <button type="submit" class="btn-large waves-effect waves-light blue col s12" name="submit">LOGIN</button>
                            </div>
                        </form>
                        <!-- Form END -->
                    <?php
    ...
    <!-- 3. jQuery (WAJIB pertama) -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>

    <!-- 4. Moment.js (WAJIB sebelum DateTimePicker) - Dihapus karena konflik -->
    <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.29.4/moment-with-locales.min.js"></script> -->

    <!-- 5. Bootstrap JS (Opsional, tapi direkomendasikan) -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/js/bootstrap.min.js"></script>

    <!-- 6. Bootstrap DateTimePicker JS (WAJIB terakhir) - Dihapus karena konflik -->
