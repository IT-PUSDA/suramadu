                ...
                $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                    ...
                    <div class="col m12" id="colres">
                        <table class="bordered" id="tbl">
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_klasifikasi WHERE uraian LIKE '%$cari%' or nama like '%$cari%' or kode like '%$cari%'ORDER BY id_klasifikasi asc LIMIT $curr, $limit");
                        ...
                        $query = mysqli_query($config, "SELECT * FROM tbl_klasifikasi order by id_klasifikasi asc");
