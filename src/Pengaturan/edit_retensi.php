        ...
        if(isset($_REQUEST['submit'])){
                ...
                if($_REQUEST['jenis_surat'] == "" || $_REQUEST['masa_inaktif'] == ""){
                    ...
                    echo '<script language="javascript">
                            window.location.href="./admin.php?page=sett&sub=ret&act=edit&jenis_surat='.$jenis_surat.'";
                          </script>';
                } else {
                ...
                if(!preg_match("/^[a-zA-Z0-9 ]*$/", $jenis_surat)){
                    ...
                    if(!preg_match("/^[a-zA-Z0-9]*$/", $masa_inaktif)){
                    ...
                    } else 
						{
                            ...
                            $query = mysqli_query($config, "UPDATE tbl_inaktif SET jenis_surat='$jenis_surat', masa_inaktif='$masa_inaktif' WHERE jenis_surat='$jenis_surat'");
            ...
            $jenis_surat = mysqli_real_escape_string($config, $_REQUEST['jenis_surat']);
            $query = mysqli_query($config, "SELECT * FROM tbl_inaktif WHERE jenis_surat='$jenis_surat'");
            if(mysqli_num_rows($query) > 0){
                ...
                if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
                        ...
                        <div class="col s12">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <ul class="left">
                                        <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">edit</i> Edit Jadwal Retensi</a></li>
                                    </ul>
                                </div>
                            </nav>
                        </div>
                    ...
                    <div class="row jarak-form">
                        ...
                        <!-- Form START -->
                        <form class="col s12" method="post" action="?page=sett&sub=ret&act=edit">

                            <!-- Row in form START -->
                            <div class="row">
                                <div class="input-field col s9">
                                    <i class="material-icons prefix md-prefix">text_fields</i>
                                    <input id="jenis_surat" type="text" class="validate" name="jenis_surat" readonly value="<?php echo $row['jenis_surat']; ?>" required>
                                        <?php
								...
								<div class="input-field col s9">
                                    <i class="material-icons prefix md-prefix">text_fields</i>
                                    <input id="masa_inaktif" type="text" class="validate" name="masa_inaktif" value="<?php echo $row['masa_inaktif']; ?>" required>
                                        <?php
                                            if(isset($_SESSION['masa_inaktif'])){
                                                $masa_inaktif = $_SESSION['jmasa_inaktif'];
