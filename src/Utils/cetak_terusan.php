        ...
        <div class="container">
            <div id="colres">
                ...
                echo '
					...
					$query2 = mysqli_query($config, "SELECT institusi, nama, alamat, kota, website FROM tbl_instansi");
					$id_user = $row['id_user'];
					$q = mysqli_query($config, "SELECT id_user,username FROM tbl_user  where id_user='$id_user' ");
					$data = mysqli_fetch_array($q);
                    list($institusi, $nama,$alamat,$kota,$website) = mysqli_fetch_array($query2);
					if(!empty($institusi)){
                    ...
                    if(!empty($nama)){
                        echo '<h5 class="up" id="nama">'.$nama.'<br/>PROVINSI JAWA TIMUR</h5><br/>';
						
                    } else {
                        echo '<h5 class="up" id="nama">kosong</h5><br/>';
                    }
                    if(!empty($alamat)){
                        echo '<h6 class="alamat">'.$alamat.'</br>Website : '.$website.'</h6>';
                    } else {
					...
					echo'
                            ...
                            <tr>
								...
								<td class="kanan"><strong>Sifat</strong></td>';
                            ...
                            <tr>
                                ...
                                <td colspan="3"class="kiri_tgh">: '.$row['perihal'].'</td>';
                            ...
                            if(mysqli_num_rows($query3) > 0){
								...
								<td colspan="2">
									<strong>Diteruskan kepada Yth:</strong></br> Sdr. '.$data2['tujuan_terusan'].'
								</td>
								<td colspan="2">
									<strong>Dengan hormat harap :</strong>
									</br> Tanggapan dan Saran
									</br> Proses lebih lanjut
									</br> Koordinasi / Konfirmasi
								</td>
