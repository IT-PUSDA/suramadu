<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['kode'] == "" || $_REQUEST['no_surat'] == "" || $_REQUEST['asal_surat'] == "" || $_REQUEST['tujuan'] == ""
                || $_REQUEST['perihal'] == "" || $_REQUEST['tgl_surat'] == "" || $_REQUEST['isi'] == ""){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $asal_surat)){
                            ...
                            echo '<script language="javascript">window.history.back();</script>';
                             ...
                             if(!preg_match("/^[a-zA-Z0-9.,() \/ -]*$/", $tujuan)){
								$_SESSION['etujuan'] = 'Form Tujuan hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-),kurung() dan garis miring(/)';
								echo '<script language="javascript">window.history.back();</script>';
							} else {
										...
										if(!preg_match("/^[0-9.-]*$/", $tgl_surat)){
                                            ...
                                            echo '<script language="javascript">window.history.back();</script>';
                                             ...
                                             if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $isi)){
												...
												$id_surat = $_REQUEST['id_surat'];
												$query1 = mysqli_query($config, "SELECT file FROM tbl_surat_masuk WHERE id_surat='$id_surat'");
                                            ...
                                            if($file != ""){
                                                ...
                                                if(in_array($eks, $ekstensi) == true){
                                                    if($ukuran < 5220350){
                                                        ...
                                                        if($files ==""){
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_surat_masuk SET kode='$nkode',no_surat='$no_surat',asal_surat='$asal_surat',tujuan='$tujuan',
															perihal='$perihal',tgl_surat='$tgl_surat',isi='$isi',file='$nfile',id_user='$id_user' WHERE id_surat='$id_surat'");

                                                            if($query == true){
                                                                $_SESSION['succEdit'] = 'SUKSES! Data A berhasil diupdate';
                                                            ...
                                                            if($query == true){
                                                                $_SESSION['succEdit'] = 'SUKSES! Data B berhasil diupdate';
                                                                header("Location: ./admin.php?page=tsm");
                                                                die();
                                                            } else {
                                                                $_SESSION['errQ'] = 'ERROR! Ada masalah dengan query';
                                                ...
                                                $query = mysqli_query($config, "UPDATE tbl_surat_masuk SET kode='$nkode',no_surat='$no_surat',asal_surat='$asal_surat',tujuan='$tujuan',
												perihal='$perihal',tgl_surat='$tgl_surat',isi='$isi',id_user='$id_user' WHERE id_surat='$id_surat'");
        ...
        $query = mysqli_query($config, "SELECT id_surat, no_agenda, kode, no_surat, asal_surat, tujuan, perihal, tgl_surat, isi, file, id_user FROM tbl_surat_masuk WHERE id_surat='$id_surat'");
        list($id_surat, $no_agenda, $kode, $no_surat, $asal_surat, $tujuan, $perihal, $tgl_surat, $isi, $file, $id_user) = mysqli_fetch_array($query);
                ...
                <form class="col s12" method="POST" action="?page=tsm&act=edit" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <input id="id_surat" type="number" class="validate" value="<?php echo $id_surat ;?>" name="id_surat" hidden required>
							<input id="no_agenda" type="text" class="validate" value="<?php echo $no_agenda ;?>" name="no_agenda" readonly required>
                                <?php
