        ...
        if(isset($_REQUEST['sub'])){
            ...
            $pg = @$_GET['pg'];
                ...
                if(mysqli_num_rows($query) > 0){
                    ...
                    if($_SESSION['admin'] ==3 OR $_SESSION['admin'] ==4 ){
                                            ...
                                            $no++;
                                             echo ' <td>'.$no.'</td>
                                                    ...
                                                    <td><a class="btn small blue waves-effect waves-light" href="?page=tsm&act=disp&id_surat='.$id_surat.'&sub=edit&id_disposisi='.$row['id_disposisi'].'">
														...
														<a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctk&id_surat='.$row['id_surat'].'&id_disp='.$row['id_disposisi'].'" target="_blank">
