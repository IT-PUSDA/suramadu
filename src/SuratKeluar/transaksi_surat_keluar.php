...
// Pengarsipan kini dipusatkan via src/SuratKeluar/arsip_assign_ajax.php (lihat arsip_modal.js)
?>
...
<!-- Modal Arsip disediakan oleh src/SuratKeluar/arsip_modal.js (global include di footer) -->
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Arsip modal logic dipusatkan di src/SuratKeluar/arsip_modal.js
...
document.addEventListener('click', function (e) {
    ...
    function fallbackCopy(text) {
        ...
        try {
            ...
            showCopyBubble(btn, 'Nomor telah disalin');
        } catch (err) {
            showCopyBubble(btn, 'Nomor telah disalin');
        }
