                                        ...
                                        <div class="col m12 white">
                                            <table>
                                                <tbody>
                                                   ...
                                                   <tr>
                                                    <td width="13%">Bidang</td>
                                                    <td width="1%">:</td>
                                                    <td width="86%">'.$row['bidang'].'</td>
                                                    </tr>
                                                ...
                                                <div class="col s9 left">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-action">
                                                            <strong>Lihat file :</strong> <a class="blue-text" href="src/SuratKeluar/lihat_file_sk.php?id_surat='.$row['id_surat'].'" target="_blank">Buka Lampiran</a>
                                                        </div>
                                                    </div>
                                                </div>
