...
if (isset($_REQUEST['submit'])) {
    ...
    echo "<div class='row agenda'><div class='col s10'><h5 class='hid'>AGENDA PRODUK HUKUM</h5><p class='warna agenda'>Produk Hukum dari tanggal <strong>$d $nm $y</strong> sampai dengan tanggal <strong>$d2 $nm2 $y2</strong></p></div><div class='col s2'><button type='submit' onClick='window.print()' class='btn-large deep-orange waves-effect waves-light right'>CETAK <i class='material-icons'>print</i></button></div></div>";
