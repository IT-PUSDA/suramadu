    ...
    <div class="col s12">
        <nav class="secondary-nav">
            <div class="nav-wrapper blue-grey darken-1">
                <ul class="left">
                    <li class="waves-effect waves-light"><a href="index.php?page=admin&act=tsk_keu&sub=add_keuangan" class="judul"><i class="material-icons">drafts</i> Input Surat Keluar - Keuangan</a></li>
                </ul>
            </div>
        </nav>
    </div>
...
<?php foreach (['errQ', 'errEmpty'] as $k) {
    if (isset($_SESSION[$k])) {
...
<div class="row jarak-form">
    <form class="col s12" method="POST" action="index.php?page=admin&act=tsk_keu&sub=proses_tambah_keuangan" enctype="multipart/form-data">
        <div class="row">
        ...
        <div class="row">
            <div class="col s12">
                ...
                <a href="index.php?page=admin&act=tsk_keu" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
            </div>
        </div>
    </form>
</div>
