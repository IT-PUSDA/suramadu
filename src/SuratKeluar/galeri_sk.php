<?php
// Baris ini memastikan koneksi database dan session selalu ada
            ...
            echo '
                ...
                if(isset($_REQUEST['submit'])){
					...
					if($_SESSION['admin'] == 4){
						...
						WHERE id_user='$id_user' and tgl_diterima BETWEEN '$dari_tanggal' AND '$sampai_tanggal' ORDER By id_surat DESC");
					} else {
							$query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar 
							WHERE tgl_surat BETWEEN '$dari_tanggal' AND '$sampai_tanggal' ORDER By id_surat DESC");
							//$query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar ORDER BY id_surat DESC LIMIT $curr, $limit");
						}

                    //$query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar WHERE tgl_surat BETWEEN '$dari_tanggal' AND '$sampai_tanggal' ORDER By id_surat DESC");
                    ...
                    <div class="hide-on-med-and-down">
                        <div class="row jarak-form black-text">
                            <form class="col s12" method="post" action="">
                                ...
                                <a class="ams hide-on-med-and-down">
                                <div class="col s6">
                    ...
                    if($_SESSION['admin'] == 4){
						$id_user=$_SESSION['id_user'];
						$query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar 
						WHERE id_user='$id_user' ORDER BY id_surat DESC LIMIT $curr, $limit");
					} else {
							$query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar ORDER BY id_surat DESC LIMIT $curr, $limit");
						}
					//$query = mysqli_query($config, "SELECT * FROM tbl_surat_keluar ORDER BY id_surat DESC LIMIT $curr, $limit");
                    if(mysqli_num_rows($query) > 0){
                        ...
                        echo '
                        <!-- Row form Start -->
                        <div class="row jarak-form black-text hide-on-med-and-down">
                            <form class="col s12" method="post" action="">
                                <div class="input-field col s3">
                                    <i class="material-icons prefix md-prefix">date_range</i>
                                    <input id="dari_tanggal" type="text" name="dari_tanggal" id="dari_tanggal" required>
