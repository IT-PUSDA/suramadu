<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['act'])){
            ...
            switch ($act) {
                case 'add':
                    include "tambah_surat_keluar1.php";
                    break;
				case 'add2':
                    include "tambah_surat_keluar2.php";
                    break;
                case 'edit':
                                ...
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
											...
											<?php
												if($_SESSION['admin'] != 2){
													echo '<a href="?page=tsk&act=add"><i class="material-icons md-24">add_circle</i> Tambah Data</a>';
												}
											?>
											</li>
                                        </ul>
                            ...
                            <table class="bordered" id="tbl">
                                <thead class="blue lighten-4" id="head">
                                    <tr>
                                        ...
                                        <th width="24%">Tujuan<br/> Perihal</th>
                                ...
                                if(mysqli_num_rows($query) > 0){
                                    ...
                                    while($row = mysqli_fetch_array($query)){
                                      echo '
                                        ...
                                        <td>'.$row['tujuan'].'<br/><strong>'.$row['perihal'].'</strong></td>';
